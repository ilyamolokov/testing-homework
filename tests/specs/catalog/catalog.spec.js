...
test.describe('Страница Catalog', () => {
  ...
  test('Полный сценарий покупки товара от добавления до появления "Happy state" @bug-id=5 @bug-id=6 @bug-id=7 @bug-id=8 @bug-id=10', async ({ catalogPage, cartPage, checkScreenshot }) => {
    await catalogPage.gotoId()
